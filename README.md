...
- 扫描本地目录，批量编辑 ID3 / FLAC 标签（保存更稳，封面不误清）
...
生成 `fpk/lemon-music-1.2.12-x86.fpk` 与 `fpk/lemon-music-1.2.12-arm.fpk`（版本以 `fpk/manifest` 为准）。说明见 [docs/fpk-install.md](docs/fpk-install.md)。
